    ...
    <>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <div className="grid grid-cols-2 gap-4 mb-12">
          <div className="bg-white/80 dark:bg-[#252220]/80 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800 text-left">
        ...
        {/* How it works */}
        <div className="bg-white/80 dark:bg-[#252220]/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-gray-800 mb-12 text-left">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/auth/login"
            className="px-8 py-4 border-2 border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-[#252220]/50 backdrop-blur-sm rounded-xl font-bold text-lg hover:border-red-300 transition-colors"
          >
            J&apos;ai déjà un compte
          </Link>
        </div>
